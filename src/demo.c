...
void network_demo(int argc, char *argv[]) {
    ...
    Vector vect000, vect001, vect010, vect011, vect100, vect101, vect110, vect111,
            vect00, vect01_1, vect01_2, vect01_3, vect10_1, vect10_2, vect10_3, vect11,
            vect0_1, vect0_2, vect1_1, vect1_2;
    ...
    if(!strcmp("xor", argv[2])){
        ...
        network = network_new(nb_layers, sizes_static);
        network_sgd(&network, &dataset, 1000, 4, 12.f);
    }
